...
config :helpdesk, HelpdeskWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "0CbBHcSsXMinbs3JAYFcAuFd020nXWi14pmmyWNrrcazBkW5NpIkI0PeOXQn/lKB",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:helpdesk, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:helpdesk, ~w(--watch)]}
  ]
...
config :helpdesk, HelpdeskWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/helpdesk_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]
